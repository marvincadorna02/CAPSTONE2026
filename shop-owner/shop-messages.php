...
<body class="role-repairshop">
  ...
  <div class="modal-overlay" id="newMsgModal">
    <div class="modal-box" style="max-width:420px;">
      ...
      <div class="modal-subtitle" style="margin-bottom:16px;">Pick a customer to start a conversation.</div>
      <input type="text" id="contactSearch" class="contact-search" placeholder="Search customer name..." />
    ...
    async function loadThreads() {
      try {
        ...
        if (!data.success || !data.threads.length) {
          col.innerHTML = '<div class="thread-empty">No conversations yet.<br><small>Tap <b>+ New</b> to message a customer.</small></div>';
          return;
        }
    ...
    async function loadContacts(q) {
      ...
      try {
        ...
        if (!data.success || !data.contacts.length) {
          list.innerHTML = '<div class="contact-empty">No customers found.<br><small>Customers appear here once they book at your shop.</small></div>';
          return;
        }
        ...
        list.innerHTML = '<div class="contact-empty">Could not load customers.</div>';
      }
    }
