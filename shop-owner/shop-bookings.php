...
$bResult = $conn->prepare("
    ...
    ORDER BY
      ...
      b.created_at DESC, b.booking_date DESC, b.booking_time DESC
");
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      <div class="nav-section" data-role="repairshop">
        ...
        <a href="shop-messages.php" class="nav-item"><span class="nav-icon"><img src="../assets/icons/talk.svg" alt="" /></span><span class="nav-text">Messages</span></a>
...
async function loadNotifications() {
  ...
  review:    `<svg viewBox="0 0 24 24" width="16" height="16"><circle cx="12" cy="12" r="10" fill="#8b5cf6"/><text x="12" y="16" text-anchor="middle" font-size="11" fill="white">★</text></svg>`,
    ...
    list.innerHTML = data.notifications.map(n => {
      ...
      const dest    = n.link ? ('../' + n.link) : n.type === 'message' ? ('shop-messages.php' + (n.other_id ? '?open=' + n.other_id : '')) : n.type === 'review' ? 'shop-reviews.php' : n.type === 'subscription' ? 'shop-subscription.php' : 'shop-bookings.php';
      const avatarBg = AVATAR_BG[n.status] || '94a3b8';
      const displayName = n.type === 'system' ? (n.sys_title || 'System') : n.type === 'subscription' ? 'Subscription' : (n.customer_name || 'Customer');
...
const msgText = n.type === 'system' ? (n.sys_body || n.sys_title || '') : n.type === 'message' ? 'Sent you a message 💬' : n.type === 'subscription'
  ? (n.status === 'active'
